...
The current QR & Barcode Studio and OCR Studio load their browser libraries from jsDelivr. Future production hardening may vendor pinned copies locally so the public tools can run with fewer external runtime dependencies.
