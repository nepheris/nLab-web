...
PUBLIC_BASE="https://nepheris.github.io/nLab-web/Library/demo/demo-input"
...
def make_calibration(root):
    out=root/"demo-input/Images"; ppm=4.0; W,H=1400,900; x0,y0=120,780
...
def make_file_samples(root):
    a=root/"demo-input/File/lot-A"; b=root/"demo-input/File/lot-B/sous-dossier"
    samples={
...
def make_dataset(root):
    out=root/"demo-input/Data"; images=out/"images"
...
def collect(root):
    files=[]
    for base in ["demo-input","demo-output","docs"]:
        p=root/base
        if p.exists():
...
def rebuild_outputs(root):
    ...
    specs={
        "pdf":{"label":"PDF Studio","prefixes":["demo-input/PDF/","demo-input/OCR/","demo-input/Zip/"]},
        "image":{"label":"Image Studio","prefixes":["demo-input/Images/"]},
        "ocr":{"label":"OCR Studio","prefixes":["demo-input/OCR/"],"also":["demo-input/PDF/pdf-scan-image-only-propre.pdf","demo-input/PDF/pdf-scan-image-only-incline-bruite.pdf"]},
        "code-json":{"label":"Code + JSON Studio","prefixes":["demo-input/Code/"],"also":["demo-input/Data/dataset-validation-complet.json"]},
        "data":{"label":"Data Studio","prefixes":["demo-input/Data/"]},
        "qr-barcode":{"label":"QR & Barcode Studio","prefixes":["demo-input/QR-Barcode/"]},
        "file":{"label":"File Studio","prefixes":["demo-input/File/","demo-input/Compare/","demo-input/Zip/"]}
    }
